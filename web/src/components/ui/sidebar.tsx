  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          'fixed top-[calc(var(--app-header-height,0px)+var(--announcement-banner-height,0px))] bottom-0 z-10 hidden h-[calc(100svh-var(--app-header-height,0px)-var(--announcement-banner-height,0px))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex',
