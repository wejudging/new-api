    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          side === 'right' &&
            'bottom-0 right-0 top-[var(--announcement-banner-height,0px)] w-3/4 border-l data-ending-style:translate-x-[2.5rem] data-starting-style:translate-x-[2.5rem] sm:max-w-sm',
          side === 'left' &&
            'bottom-0 left-0 top-[var(--announcement-banner-height,0px)] w-3/4 border-r data-ending-style:translate-x-[-2.5rem] data-starting-style:translate-x-[-2.5rem] sm:max-w-sm',
          side === 'top' &&
